...
describe('Service Tests', () => {
    ...
    describe('MenuData Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MenuDataService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/menu-data/' + 123);
            });
            it('should return MenuData', () => {

                let entity: MenuData;
                service.find(123).subscribe((_entity: MenuData) => {
                    entity = _entity;
                });
