...
describe('Service Tests', () => {
    ...
    describe('ShopInfo Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ShopInfoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/shop-infos/' + 123);
            });
            it('should return ShopInfo', () => {

                let entity: ShopInfo;
                service.find(123).subscribe((_entity: ShopInfo) => {
                    entity = _entity;
                });
