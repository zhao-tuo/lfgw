...
describe('Service Tests', () => {
    ...
    describe('ProjectTransactionRecord Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ProjectTransactionRecordService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/project-transaction-records/' + 123);
            });
            it('should return ProjectTransactionRecord', () => {

                let entity: ProjectTransactionRecord;
                service.find(123).subscribe((_entity: ProjectTransactionRecord) => {
                    entity = _entity;
                });
